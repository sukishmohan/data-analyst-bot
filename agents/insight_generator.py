"""
insight_generator.py — Insight Generation & Reflection Agent
...
from utils import call_llm, call_llm_json, get_logger, truncate
...
def generate_insights(
    ...
    insights = call_llm(prompt=user_msg, system=_INSIGHT_SYSTEM, temperature=0.4)
...
def reflect(
    ...
    result = call_llm_json(prompt=user_msg, system=_REFLECTION_SYSTEM, temperature=0.15)
