...
step-by-step analytical execution plan. Uses NVIDIA NIM API.
"""

import json
from typing import Any

from utils import call_llm_json, get_logger
...
def generate_plan(intent: dict[str, Any], profile: dict) -> dict[str, Any]:
    ...
    plan = call_llm_json(prompt=user_msg, system=system, temperature=0.15)
