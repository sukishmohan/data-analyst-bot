"""
main.py — AI Data Analyst Agent — Main Orchestrator
...
from utils import get_logger, safe_print, check_llm_available, LLM_MODEL
...
"""
    ...
    if not check_llm_available():
        safe_print("[ERROR] NVIDIA_API_KEY is not set!")
        safe_print("   Set the NVIDIA_API_KEY environment variable or add it to Streamlit secrets.")
        sys.exit(1)
