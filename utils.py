...
DEFAULT_GROQ_KEY = "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"

def get_api_key():
    if st and hasattr(st, "secrets") and "GROQ_API_KEY" in st.secrets:
        return st.secrets["GROQ_API_KEY"]
    return os.getenv("GROQ_API_KEY", DEFAULT_GROQ_KEY)

GROQ_API_KEY = get_api_key()

# Using the blazing fast Groq Llama3 8B model!
